...
**Class participation (5%)**: As a research-focused course, we understand that students often have conflicting commitments (e.g., conferences). We expect students to attend and actively participate whenever possible, and notify the instructors in advance if they will be unable to attend class.
